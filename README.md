...
**This project was AI-generated using a variety of tools and resources, including manually coded scaffolding for the AI. It's an agentic prototype and is tested via agent.**
